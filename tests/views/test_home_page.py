...
class TestHomePage(PMGLiveServerTestCase):
    ...
    def contains_recent_committee_meetings(self):
        ...
        self.contains_recent_committee_meeting(self.fx.CommitteeMeetingData.arts_meeting_one)
        self.contains_recent_committee_meeting(self.fx.CommitteeMeetingData.arts_meeting_two)
    ...
    def contains_recent_questions_and_replies(self):
        ...
        self.contains_question(self.fx.CommitteeQuestionData.arts_committee_question_one)
