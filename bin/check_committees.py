                    ...
                    if committee_name in committee_name_map:
                        ...
                        if "Portfolio Committee on" in committee_name:
                            committee_name = committee_name[
                                len("Portfolio Committee on") + 1 :
                            ]
                        committee = Committee.find_by_inexact_name(
                            committee_name, candidates=na_committees
                        )

                    elif row["House"] == "NCOP":
                        if "Select Committee on" in committee_name:
                            committee_name = committee_name[
                                len("Select Committee on") + 1 :
                            ]
                        committee = Committee.find_by_inexact_name(
                            committee_name, candidates=ncop_committees
                        )

                    else:
                        committee = Committee.find_by_inexact_name(
                            committee_name, candidates=all_committees
                        )
