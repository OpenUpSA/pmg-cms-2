...
Revision ID: 4fe2abcf1e9f
Revises: None
Create Date: 2019-07-15 17:31:28.636212

"""

# revision identifiers, used by Alembic.
revision = "4fe2abcf1e9f"
down_revision = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["speaker_id"],
            ["member.id"],
            name=op.f("fk_house_speaker_id_member"),
            use_alter=True,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["house_id"],
            ["house.id"],
            name=op.f("fk_member_house_id_house"),
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
