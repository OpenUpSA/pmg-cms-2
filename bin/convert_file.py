            ...
            for row in reader:
                ...
                writer.writerow(
                    [
                        ...
                        pmg,
                        alt,
                        row["Attendance Chair"],
                        chair,
                        row["First Name Chairperson"],
                        row["Party Affiliation Chairperson"],
                        province,
                        row["Surname Chairperson"],
                        row["Title Chairperson"],
                    ]
                )
                        ...
                        try:
                            writer.writerow(
                                [
                                    ...
                                    ost,
                                    pmg,
                                    row["Alt (Y or N) Member " + i],
                                    row["Attendance Member " + i],
                                    chair,
                                    row["First Name Member " + i],
                                    row["Party Affiliation Member " + i],
                                    province,
                                    row["Surname Member " + i],
                                    row["Title Member " + i],
                                ]
                            )
