...
SOUNDCLOUD_APP_KEY_ID = env.get("SOUNDCLOUD_APP_KEY_ID", '43b75cb8efda851b186580bdd8f90f0b')
SOUNDCLOUD_APP_KEY_SECRET = env.get("SOUNDCLOUD_APP_KEY_SECRET", '346099f5af473399043f9c23b214b86d')
SOUNDCLOUD_USERNAME = env.get("SOUNDCLOUD_USERNAME", 'info@pmg.org.za')
SOUNDCLOUD_PASSWORD = env.get("SOUNDCLOUD_PASSWORD", 'monitors98')
